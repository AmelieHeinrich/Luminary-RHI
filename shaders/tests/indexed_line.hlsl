...
// 4 vertices forming a visible rectangle inset from the viewport edges
static const float3 lineVertices[4] =
{
...
{
    VSOutput output;
    output.position = float4(lineVertices[vertexId], 1.0f);
